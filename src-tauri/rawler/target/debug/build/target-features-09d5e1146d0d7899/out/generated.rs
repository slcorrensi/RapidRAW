...
pub const CURRENT_TARGET: Target = {
    ...
    let target = if let Ok(feature) = Feature::new(arch, "aes") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "crc") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "dit") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "dotprod") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "dpb") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "dpb2") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "fcma") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "fhm") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "flagm") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "fp16") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "frintts") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "jsconv") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "lor") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "lse") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "neon") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "paca") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "pacg") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "pan") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "pmuv3") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "ras") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "rcpc") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "rcpc2") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "rdm") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "sb") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "sha2") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "sha3") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "ssbs") { target.with_feature(feature) } else { target };
    let target = if let Ok(feature) = Feature::new(arch, "vh") { target.with_feature(feature) } else { target };
    target
};
